...
// 같은 클래스 안에서 메서드를 호출하면 Spring의 트랜잭션 프록시를 거치지 않아서 트랜잭션 무시
// 그래서 독립된 트랜잭션을 보여주기 위해 서로 다른 빈으로 분리 해 프록시를 거치게 해야 한다
@Service
...
public class AuditService {
  ...
  // '활동 등록' 로직이 별도의 트랜잭션을 가지고 있어도, 이 메서드는 자기만의 트랜잭션을 새로 열 것
