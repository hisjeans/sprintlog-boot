...
// 태그는 "활동에 속한" 자원, 그래서 독립 주소(/api/tags)가 아니라 부모를 경로에 포함한 중첩 url로 표현하자
...
public class ActivityTagController {
    ...
    @GetMapping
    public CollectionModel<String> getTags(@PathVariable Long activityId){ // 경로 상에 아이디가 있으니 @PathVariable
